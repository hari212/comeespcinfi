...
<script>
	...
	alert("index page nunchi controlleraction dwara login page ki velthunnam anukuntunna...let's see...!!");
		var port = window.location.port;
		if (port.length > 0){
			port = ":" + port;
		}
		var urlToGo = window.location.protocol + '//' + window.location.hostname + port + "/comeespcinfi/ControllerAction.do"
	   ...
	   with(top.document)
         {
           ...
           writeln ('<HTML><HEAD><TITLE>Welcome to EFMS Local Services 1</TITLE></HEAD>');
	   ...
	   with(top.document)
         {
           ...
           writeln ('<HTML><HEAD><TITLE>Welcome to EFMS Local Services 2</TITLE></HEAD>');
