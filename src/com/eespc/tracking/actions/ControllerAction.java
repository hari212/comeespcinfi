...
public class ControllerAction extends Action {
	...
	{
		System.out.println("we are at control action constructor...!");
	}
	...
	public ActionForward execute(ActionMapping actionmapping,
		...
		System.out.println(" http servlet request attribute of user info : "+uservo);
		String s1 = httpservletrequest.getParameter("id");
		System.out.println(s1+"-------------> idi id parameter from http servlet request ");
		System.out.println(httpservletrequest.getServletPath()+"  servlet path....................%%%%%%%%%%%%%%%%%%%%");
		if (uservo == null)
		...
		System.out.println(s+"********************************** this default action from menu list...!!!!!!!!!!");
		...
		if (s == null) {
			...
			uservo = userentity.getByLoginName(s2);//ikkada nunchi sqlutil lo ki velli user nu check chesthunnaru adi via usetentity class nundi....!!
	...
	//		System.out.println("checking the menu items.........!!!"+s1);
